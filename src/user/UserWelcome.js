...
import slideshowImage1 from '../assets/slideshowImage1.jpg'; // New image imports for slideshow
    ...
    <div className={styles.userWelcomeContainer}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.resinInfoContainer}>
          ...
          <p className={styles.resinInfoText}>
          ...
          <p className={styles.resinInfoText}>
            ...
            <ul className={styles.resinInfoList}>
              <li>High clarity and glossy finish</li>
              <li>Fast curing times</li>
              <li>Easy to use and mix</li>
              <li>Durable and long-lasting</li>
              <li>Available in various colors and formulations</li>
            </ul>
          </p>
          <p className={styles.resinInfoText}>
