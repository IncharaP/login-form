...
import OrdersContext from '../context/OrdersContext'; // Import the context
...
const AdminWelcome = () => {
  ...
  useEffect(() => {
    ...
    // Animate the total orders count
    incrementCounts(totalOrderedProducts, setDisplayedTotalOrders);
