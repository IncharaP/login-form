...
const AddItem = () => {
  ...
  const handleFormSubmit = (event) => {
    ...
    if (!itemName || !itemPrice || !itemImageFile || !itemStock || !itemCategory) {
      setMessage('Product Name, Product Price, Product Image, Stock, and Category are required fields.');
      return;
    }
    ...
    reader.onloadend = () => {
      ...
      addItem({
        ...
        category: itemCategory, // Include item category
        image: base64Image
      });
      ...
      <div className={styles.addItemContainer}>
        ...
        <div className={styles.formGroup}>
            ...
            >
              ...
              <option value="Resin Trays">Resin Trays</option>
              <option value="Keychains or Bookmarks">Keychains or Bookmarks</option>
              <option value="Jewelry Boxes">Jewelry Boxes</option>
              <option value="Paintings/ Mantra Frames">Paintings/ Mantra Frames</option>
            </select>
          </div>
          <div className={styles.formGroup}>
